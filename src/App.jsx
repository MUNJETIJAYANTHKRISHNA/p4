...
class App extends Component {
  ...
  autoSlide(){
    let nextIndex = (this.state.index + 1 )% this.state.slideCount; // Loop back to 0 after reaching the last slide
    document.getElementById('slideRef').style.transform = `translateX(-${nextIndex * 100}%)`; // Adjust the slide position
